...
export const bindFirebaseActions = (firebase: Firebase, actions: Input): Output => {
  ...
  throw Error('Invalid input, passed actions is not function nor object full of functions')
}
