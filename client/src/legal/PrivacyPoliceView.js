  ...
  render() {
    return (
      <div className="legal">
        ...
        <p>
          Mojo ("us", "we", or "our") operates the
          https://mojo-yt.firebaseapp.com/ website (the "Service").
        </p>
        <p>
        ...
        <h2>Use of Data</h2>
        <p>Mojo uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Mojo will take all steps reasonably necessary to ensure that your data
        ...
        <p>
          Mojo may disclose your Personal Data in the good faith belief that
          such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Mojo</li>
          <li>
