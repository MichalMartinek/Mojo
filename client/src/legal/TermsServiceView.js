  ...
  render() {
    return (
      <div className="legal">
        ...
        <p>Last updated: July 27, 2018</p>

        <p>
          Please read these Terms of Service ("Terms", "Terms of Service")
          carefully before using the https://mojo-yt.firebaseapp.com/ website
          (the "Service") operated by Mojo ("us", "we", or "our").
        </p>
        ...
        <p>
          ...
          access the Service. This Terms of Service agreement for Mojo is{' '}
        ...
        <p>
          ...
          that are not owned or controlled by Mojo.
        </p>

        <p>
          Mojo has no control over, and assumes no responsibility for, the
          content, privacy policies, or practices of any third party web sites
          or services. You further acknowledge and agree that Mojo shall not be
